...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default: 'bg-neutral-900 text-white hover:bg-neutral-700 shadow-soft',
        outline: 'border border-neutral-200 bg-white hover:bg-neutral-50 text-neutral-900',
        ghost: 'hover:bg-neutral-100 text-neutral-700',
        link: 'underline-offset-4 hover:underline text-neutral-900 p-0 h-auto',
        // Role-aware variants — consume CSS variables set by .role-* parent
        'role-primary': 'text-white shadow-soft hover:-translate-y-px',
        'role-outline': 'border text-[var(--role-text)] bg-[var(--role-light)] hover:bg-white',
